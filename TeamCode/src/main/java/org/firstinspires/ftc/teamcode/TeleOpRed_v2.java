...
@TeleOp
public class TeleOpRed_v2 extends LinearOpMode { // TODO: WRITE RIGGING + SPECIMEN REWRITE
        ...
        while (opModeIsActive()) {
            ...
            switch (state) {
                ...
                case SAMPLE_INTAKE_1:
                    robot.setHSliderPos(HSliderPosition.OUT);
                    robot.setArmPos(ArmPosition.TRANSFER);
                ...
                case SPECIMEN_INTAKE:
                    ...
                    if (!isSpecimen) {state = State.SAMPLE_INTAKE_1;}
